...
public class EMVActivity extends BaseAppCompatActivity {
    ...
    private void initView() {
        ...
        item = findViewById(R.id.item_sale);
        leftText = item.findViewById(R.id.left_text);
        leftText.setText(R.string.emv_sale_basic);
        item.setOnClickListener(this);

        item = findViewById(R.id.item_atr);
        leftText = item.findViewById(R.id.left_text);
        leftText.setText(R.string.emv_atr_basic);
        item.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.item_sale:
                ...
                break;
            case R.id.item_atr:
                openActivity(AtrActivity.class);
                break;
        }
    }
